...
public class Calculator {
  public static void main(String[] args) {
    ...
    while (command != 0) {
      System.out.println("\n[0] Exit program   [1] Create matrix   [2] Rename matrix   "
          + "[3] Delete matrix   [4] Print matrix   [5] List saved matrices");
      System.out.println("[6] Addition   [7] Subtraction   [8] Scalar multiplication   "
          + "[9] Matrix multiplication   [10] Transpose   [11] Determinant   [12] Inverse   "
          + "[13] Trace");
